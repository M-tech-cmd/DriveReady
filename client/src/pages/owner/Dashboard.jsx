...
const Dashboard = () => {
  ...
  const dashboardCards = [
    ...
    { title: "Pending Bookings:", value: data.pendindBookings, icon: assets.cautionIconColored },
...
const fetchDashbordData = async () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="Admin Dashboard" subTitle="Monitor overal platform prrformance
      including total cars, bookings, revenue, and recent activities"/>

      <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-max-w-3xl'>
      ...
      <div className='flex flex-wrap items-start pt-4 mb-8 gap-6 w-full'>
        {/* recent booking */}
            ...
            <div key={index} className='mt-4 flex items-center justify-between'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  ...
                  <p className='text-sm text-grsy-500'>{booking.createdAt.split('T')[0]}</p>
                </div>
              </div>

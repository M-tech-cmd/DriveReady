      ...
      <div className='group relative'>
        <label htmlFor="image">
          <img src={image ? URL.createObjectURL(image) : user?.image ||
            "https://pikaso.cdnpk.net/private/production/1852360602/upload.png?token=exp=1773446400~hmac=e3923a33e67a69d9aa94bf993fe4a0a95b24d89423735f451050b38d46921dee&preview=1"}
      ...
      <div className='w-full'>
        {ownerMenuLinks.map((link, index) => (
          <NavLink 
            key={index} 
            to={link.path}
            end={link.path === '/owner'} // Add 'end' prop for exact matching on base route
            className={({ isActive }) => `
              relative flex items-center gap-2 w-full py-3 pl-4 first:mt-6 transition-colors
